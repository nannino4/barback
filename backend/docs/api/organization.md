...
### POST /api/orgs
Create a new organization with a Stripe subscription ID.
...
```json
{
  "message": "Subscription \"sub_1234567890abcdef\" is not active",
...
```json
{
  "message": "Subscription \"sub_1234567890abcdef\" does not belong to the current user",
